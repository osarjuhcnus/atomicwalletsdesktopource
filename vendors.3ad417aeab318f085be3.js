(window.webpackJsonp = window.webpackJsonp || []).push([
    [261], {
        5397: function(e, t, n) {
            ...
            const w = 1e9,
                T = "150000";
            class ETHCoin extends((0, b.StakingMixin)((0, v.Web3Mixin)((0, y.NftMixin)((0, v.HasProviders)((0, v.HasTokensMixin)(o.default)))))) {
                constructor({
                    alias: e,
                    notify: t,
                    feeData: n,
                    ...
                    super({
                        ...
                        socket: r,
                        feeData: n
                    }), this.gasLimit = String(n.gasLimit), this.stakingGasLimit = n.stakingGasLimit || T, this.nftGasLimitCoefficient = n.nftGasLimitCoefficient, this.nftGasPriceCoefficient = n.nftGasPriceCoefficient, this.gasLimitCoefficient = n.gasLimitCoefficient, this.gasPriceCoefficient = n.gasPriceCoefficient, this.defaultGasPrice = new this.BN(n.defaultGasPrice * w), this.defaultMaxGasPrice = n.defaultMaxGasPrice, this.gasPriceConfig = null, this.bannedTokens = [], this.resendTimeout = n.resendTimeout;
                    const s = a.find(({
                        className: e
                    }) => "Web3Explorer" === e);
                    this.web3 = new d.Web3Explorer({
                ...
                getTokenTransactions({
                    ...
                    if (!e) throw new Error(this.ticker + ": `contract` parameter should be defined");
                ...
                async getTransactions() {
                    if (!this.address) throw new Error("ETH: getTransactions: address is not loaded");
                    const {
                        transactions: e = [],
                        tokenTransactions: t = [],
                        failed: n = []
                ...
                getFeeSettings() {
                    return f.default.get("eth-gas-price")
                }
                loadWallet(e) {
                    return new Promise(async (t, n) => {
                        ...
                        r ? (this.privateKey = r.privateKey, this.address = r.address, this.getNonce(), t(this)) : n(new Error("ETH cant get a wallet!"))
                    })
                }
                getAddress() {
                    try {
                ...
                async getMaxFeePerGas(e) {
                    ...
                    if (!t) throw new h.ExternalError({
                ...
                async estimateGasForSendNft(e, t, n, a, i = 1) {
                    try {
                        ...
                        throw console.warn(e), new h.ExternalError({
                            type: m.EXTERNAL_ERROR,
                            error: e,
                            instance: this
                        })
                    ...
                    const t = await this.getModerateGasPrice(),
                        {
                            fastest: n = null,
                            standard: a = null
                        } = null != t && t.fastest ? t : await this.getProvider("node").getGasPrice();
                    if (e) return a || this.defaultGasPrice;
                    if (!n) return this.defaultGasPrice;
                    const i = new this.BN(this.gasPriceCoefficient),
                        r = new this.BN(Number(n) / w).add(i);
                    return new this.BN(Number(r) * w)
                }
                async getModerateGasPrice() {
                    let e;
                    try {
                        e = await f.default.get("eth-gas-price", !1, {
                            timeout: 1e4
                        })
                    } catch (e) {
                        console.warn(e)
                    ...
                    return e && e.fastest && e.safeLow ? {
                        fastest: new this.BN(e.fastest / 10 * w),
                        standard: new this.BN(e.safeLow / 10 * w)
                    } : {}
                }
                async estimateGas(e, t, n, a = T) {
                ...
                async getStakingInfo() {
                    const e = await this.getPredefinedValidators(),
                        t = Object.values(this.tokens).filter(({
                            contract: t
                        }) => e.some(({
                            address: e
                    ...
                    const n = t.reduce((e, {
                        ...
                        id: i,
                        decimal: r
                    }) => (e.staked = new g.default(e.staked.toBN().add(new this.BN(n)), this), e.validators[t] = {
                        address: t,
                        staked: new g.default(n, {
                            ticker: a,
                            id: i,
                            decimal: r
                        })
                    }, e), {
                        staked: new g.default("0", this),
                        validators: {}
                    });
                    return this.setBalances(await this.makeStakingInfoStruct(n)), this.balances
                }
                calculateTotal({
                    staked: e
                }) {
                    var t;
                    const n = new this.BN(null !== (t = this.balance) && void 0 !== t ? t : 0).add(e.toBN());
                    return new g.default(n, this)
                }
                async calculateAvailableForStake() {
                    const e = await this.getFee({
                        ...
                        t = await this.getFee(),
                        n = e.add(t),
                        a = await this.availableBalance(n);
                    return new g.default(this.toMinimalUnit(a), this)
                }
                getUserValidators() {
                ...
                async createDelegationTransaction({
                    ...
                    const a = this.createSmartContractCall({
                        ...
                        action: "stake",
                        args: ["0xF07A4a4d2fDE367A55FaC93761ecc8181148b826"]
                    });
                    return await this.createTransaction({
                        address: e,
                        amount: t,
                        paymentData: a,
                        gasLimit: this.stakingGasLimit || await this.estimateGas(t, e)
                    })
                }
                createToken(e) {
                    return e.isStakable ? new u.StakableMaticETHToken({
                        parent: this,
                        ...e
                    }) : new u.ETHToken({
                        parent: this,
                ...
                async getTokenList() {
                    ...
                    try {
                        e = await f.default.get("ethereum-tokens", !0)
                    } catch (e) {
                        p.default.error({
                            instance: this,
                            error: e
                ...
                async getBannedTokenList() {
                    let e;
                    try {
                        e = await f.default.get("ethereum-tokens-banned", !0)
                    } catch (e) {
                        p.default.error({
                            instance: this,
                            error: e
                ...
                getTokenObject(e, t = "user") {
                    return "user" === t ? this.getTokenFromUserList(e) : this.getTokenFromCommonList(e)
                }
                getTokenFromUserList(e) {
                    return {
                        name: e.name,
                        ticker: e.symbol,
                ...
                getTokenFromCommonList(e) {
                    ...
                    return {
                        ...
                        isCustom: null !== (t = e.isCustom) && void 0 !== t && t,
