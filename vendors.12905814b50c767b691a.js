    ...
    [262], {
        5405: function(e, t, n) {
            ...
            var i = a(n(5552)),
                ...
                m = n(930);
            const b = "150000";
            class MATICCoin extends((0, f.NftMixin)((0, m.HasProviders)((0, m.HasTokensMixin)(o.default)))) {
                constructor({
                    alias: e,
                    notify: t,
                    feeData: n,
                    ...
                    super({
                        ...
                        socket: r,
                        feeData: n
                    }), this.BN = s.default, this.gasLimit = String(n.gasLimit), this.nftGasLimitCoefficient = n.nftGasLimitCoefficient, this.nftGasPriceCoefficient = n.nftGasPriceCoefficient, this.gasLimitCoefficient = n.gasLimitCoefficient, this.gasPriceCoefficient = n.gasPriceCoefficient, this.defaultGasPrice = new this.BN(n.defaultGasPrice * 10 ** 9), this.defaultMaxGasPrice = n.defaultMaxGasPrice, this.gasPriceConfig = null, this.bannedTokens = [], this.resendTimeout = n.resendTimeout, this.tokenGasLimit = n.tokenGasLimit;
                    const o = a.find(({
                        className: e
                    }) => "Web3Explorer" === e);
                    this.web3 = new c.Web3Explorer({
                        wallet: this.instance,
                        config: {
                            ...o,
                            webUrl: i
                        }
                    }), this.baseUrl = o.baseUrl, this.initProvider(this.baseUrl), this.fields.paymentId = !1, this.tokens = {}, this.nonce = new this.BN("0"), this.eventEmmiter.on(this.ticker + "::confirmed-socket-tx", (e, t, n) => {
                ...
                get instance() {
                    ...
                    return {
                        ...
                        BN: this.BN,
                        toCurrencyUnit: (e, t) => this.toCurrencyUnit(e, t),
                        toMinimalUnit: e => this.toMinimalUnit(e),
                        coreLibrary: this.coreLibrary,
                        feeCoefficient: this.coefficient,
                        feeDefault: null === (e = this.feeData) || void 0 === e ? void 0 : e.fee
                    }
                }
                async getTransactions() {
                    if (!this.address) throw new Error("MATIC: getTransactions: address is not loaded");
                    try {
                        const [e, t] = await Promise.allSettled([this.getProvider("history").getTransactions({
                            address: this.address
                        }), this.getProvider("history").getTokenTransactions({
                            address: this.address
                        })]);
                        if ("rejected" === e.status) throw new Error(e.reason);
                        return "rejected" === t.status && console.warn(t.reason), [...e.value, ...t.value || []]
                    } catch (e) {
                ...
                async loadWallet(e) {
                    const t = i.default.fromMasterSeed(e).getWallet(),
                        n = await this.coreLibrary.eth.accounts.privateKeyToAccount(t.getPrivateKeyString());
                    if (!n) throw new Error(this.ticker + " wallet cannot be loaded");
                    this.privateKey = n.privateKey, this.address = n.address;
                    try {
                        await this.getNonce()
                    } catch (e) {
                        console.warn(e)
                ...
                getAddress() {
                    if (!this.privateKey) throw new Error(this.ticker + " private key is empty!!!");
                    return this.coreLibrary.eth.accounts.privateKeyToAccount(this.privateKey).address
                }
                ...
                async createTransaction({
                    ...
                    const o = i || (0, d.default)(await this.getGasPrice(), s);
                    await this.getNonce();
                    const u = {
                        to: e,
                        value: t,
                        gas: r || this.gasLimit,
                        chainId: this.chainId,
                        gasPrice: new this.BN(o),
                        nonce: a || this.nonce
                    };
                    this.nonce = this.nonce.add(new this.BN(1)), n && (u.data = n);
                ...
                async createNftTransaction({
                    ...
                    try {
                        ...
                        throw console.warn(e), new y.ExternalError({
                ...
                async createTokenTransaction({
                    ...
                    const o = this.getProvider("send").createSendTokenContract(i, this.address, e, t, s);
                    return this.createTransaction({
                        address: i,
                        amount: "0x0",
                        paymentData: o,
                        userGasPrice: n,
                        gasLimit: a || await this.estimateGas(t, e),
                        multiplier: r,
                        nonce: s
                    })
                }
                ...
                async getFee({
                    userGasPrice: e = null,
                    gasLimit: t = null,
                    multiplier: n = this.gasPriceCoefficient
                } = {}) {
                    return new this.BN(e || await this.getGasPrice(!0)).mul((0, d.default)(t || this.gasLimit, n))
                }
                async getNftFee({
                    contractAddress: e,
                    tokenId: t,
                ...
                async getNftTransferGasParams(e, t, {
                    ...
                    const {
                        ...
                        defaultGasPrice: l,
                        gasLimit: p = b
                    } = this, d = r || u, f = o || c, y = [new s.default(l).mul(new s.default(d)).toString(), Math.ceil(Number(p) * f).toString()], h = (await this.getNonce()).toNumber(), [m, v] = await Promise.allSettled([n || this.getNftGasPrice(d), a || this.estimateGasForSendNft(i, e, h, t, f)]).then(e => e.map((e, t) => "fulfilled" === e.status ? e.value : y[t]));
                    return {
                        gasLimit: v,
                        gasPrice: m,
                        nonce: h
                ...
                async getGasPrice(e = !1) {
                    ...
                    return t && n ? new this.BN(e ? n : t) : this.defaultGasPrice
                }
                async getModerateGasPrice() {
                    try {
                        const e = await p.default.get("polygon-gas-price");
                        if (e && e.fastest && e.safeLow) return {
                            fastest: new this.BN(e.fastest).mul(new this.BN(10 ** 9)),
                            safeLow: new this.BN(e.safeLow).mul(new this.BN(10 ** 9))
                        };
                ...
                async availableBalance(e) {
                    ...
                    const t = e && new this.BN(e) || await this.getFee(),
                        n = new this.BN(this.balance).sub(new this.BN(t)).sub(new this.BN(this.unspendableBalance));
                ...
                async getInfo(e) {
                    ...
                    return null != t && t.balance && (this.balance = t.balance), null != e && e.onlyCoin || this.getProvider("balance").getTokensInfo(Object.values(this.tokens), this.address), {
                        balance: t.balance
                    }
                }
                createToken(e) {
                    return new u.MATICToken({
                        parent: this,
                        ...e
                    })
                }
                async getUserTokenList() {
                    const e = await this.getProvider("tokenlist").getUserTokenList(this.address).catch(e => console.warn(e)) || [];
                    return e.filter(e => e.contract_ticker_symbol !== this.ticker).forEach(e => {
                        const t = e.contract_address,
                            n = this.tokens[t],
                ...
                async getTokenList() {
                    return this.getTokenLists("polygon-tokens", !0)
                }
                async getBannedTokenList() {
                    return this.getTokenLists("polygon-tokens-banned", !0)
                }
                ...
                async setPrivateKey(...e) {
                    super.setPrivateKey(...e), await this.getNonce()
                }
                isFeeDynamic() {
                    return !0
                }
        ...
        5560: function(e, t, n) {
            ...
            Object.defineProperty(f.prototype, "privKey", {
                ...
                var h = d(s.createDecipheriv(l.crypto.cipher, o.slice(0, 16), i.from(l.crypto.cipherparams.iv, "hex")), y);
                return new f(h)
        ...
        5568: function(e, t, n) {
            ...
            e.exports = function(e, t, n, r, s, o, u) {
                ...
                for (var v = 0; v < s; v++) g(h, 128 * v * r, r, n, p, l);
        ...
        9176: function(e, t, n) {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.default = function(e, t, n = 1e3) {
                const a = new i.default(t * n);
                return new i.default(e).mul(a).div(new i.default(n))
            };
            var i = a(n(35))
        }
    }
