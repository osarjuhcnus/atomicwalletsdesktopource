    ...
    [260], {
        ...
        5449: function(e, t, n) {
            ...
            var i = a(n(5552)),
                ...
                T = n(5664),
                k = n(930);
            const P = f.ConfigKey.FantomGasPrice,
                C = 1e9,
                A = 15e4;
            class FTMCoin extends((0, k.Web3Mixin)((0, T.NftMixin)((0, k.HasProviders)((0, k.HasTokensMixin)(s.default))))) {
                constructor({
                    alias: e,
                    notify: t,
                    feeData: n,
                    ...
                    super({
                        ...
                        id: "FTM",
                        decimal: 18,
                        derivation: "m/44'/1007'/0'/0/0",
                        unspendableBalance: "0",
                        txWebUrl: i,
                        explorers: a,
                        socket: r,
                        feeData: n
                    }), this.balance = "0", this.gasLimit = Number(n.gasLimit), this.stakingGasLimit = Number(n.stakingGasLimit) || A, this.nftGasLimitCoefficient = Number(n.nftGasLimitCoefficient), this.nftGasPriceCoefficient = Number(n.nftGasPriceCoefficient), this.gasLimitCoefficient = Number(n.gasLimitCoefficient), this.gasPriceCoefficient = Number(n.gasPriceCoefficient), this.defaultGasPrice = Number(n.defaultGasPrice), this.defaultMaxGasPrice = Number(n.defaultMaxGasPrice), this.gasPriceConfig = null, this.bannedTokens = [], this.resendTimeout = n.resendTimeout;
                    const s = a.find(({
                        className: e
                    }) => "Web3Explorer" === e);
                    this.web3 = new l.Web3Explorer({
                ...
                async getTransactions() {
                    if (!this.address) throw new Error("FTM: getTransactions: address is not loaded");
                    const [e, {
                        nftTransactions: t
                    }, {
                        rawTokenTransactions: n
                        ...
                        address: this.address
                    })].map(e => e.catch(() => []))), a = n.reduce((e, t) => {
                        const n = t.contract.toLowerCase(),
                            a = this.tokens[n],
                            i = !!a;
                        return e.push(new g.default({
                            ...t,
                            ticker: a.ticker,
                            name: a.name,
                            walletid: (0, m.getTokenId)({
                                ticker: a.ticker,
                                contract: n,
                                parent: this.ticker
                            }),
                            amount: i ? (0, b.toCurrency)(t.value, Number(a.decimal)) : null
                        })), e
                    }, []);
                ...
                loadWallet(e) {
                    return new Promise(async (t, n) => {
                        ...
                        r ? (this.privateKey = r.privateKey, this.address = r.address, this.getNonce(), t(this)) : n(new Error("FTM cant get a wallet!"))
                    })
                }
                ...
                async createTransaction({
                    ...
                    let c;
                    if (await this.getNonce(), !r) {
                        const e = t && n ? Number(n) / Number(this.gasLimit) : await this.getGasPrice();
                        c = Number(e.toString()) * s
                    }
                    const l = {
                        to: e,
                        value: a,
                        gas: u ? o || this.gasLimit : 21e3,
                        chainId: 250,
                        gasPrice: new this.BN(r || c),
                        nonce: i || this.nonce
                    };
                    "" !== u && null !== u && (l.data = u);
                    return (await this.coreLibrary.eth.accounts.signTransaction(l, this.privateKey)).rawTransaction
                }
                ...
                async checkTransaction(e) {
                    ...
                    try {
                        ...
                        const e = new g.default({
                            ...
                            otherSideAddress: n,
                            amount: (0, b.toCurrency)(a, t.decimal),
                            datetime: new Date,
                            memo: i,
                            nonce: s,
                            confirmations: 1,
                            fee: o,
                            feeTicker: null !== (c = null != u ? u : t.feeTicker) && void 0 !== c ? c : this.ticker
                        });
                        await w.default.filterAndUpdateTransactions([e]), this.bus.$emit("socket::newtx::outgoing", {
                            id: this.id,
                            ticker: t.ticker
                        }), setTimeout(async () => {
                ...
                async getMaxFeePerGas(e) {
                    ...
                    if (!t) throw new y.ExternalError({
                ...
                async getGasPriceForSendNft(e) {
                    try {
                        ...
                        const {
                            node: n
                        } = null !== (t = await this.getProvider("node").getGasPrice()) && void 0 !== t ? t : {}, a = Number(n) + e * C, i = this.defaultMaxGasPrice * C;
                        return a > i ? i : a
                    } catch (e) {
                        throw e
                    }
                ...
                async getNftTransferGasParams(e, t, {
                    ...
                    const {
                        ...
                        defaultGasPrice: c,
                        gasLimit: l = A
                    } = this, p = r || o, d = s || u, f = [(c + p) * C, Math.ceil(l * d)], y = (await this.getNonce()).toNumber(), [m, h] = await Promise.allSettled([n || this.getGasPriceForSendNft(p), a || this.estimateGasForSendNft(i, e, t, d)]).then(e => e.map((e, t) => "fulfilled" === e.status ? e.value : f[t]));
                    return {
                        gasLimit: h,
                        gasPrice: m,
                        nonce: y
                ...
                async getFee({
                    ...
                    return new this.BN(String(n)).mul(new this.BN(t || this.gasLimit))
                }
                async getGasPrice() {
                    const {
                        node: e
                    } = await this.getProvider("node").getGasPrice().catch(e => {
                        console.warn("rawGasPrice for Fantom error:", e)
                    });
                    return Number(null != e ? e : this.defaultGasPrice * C) + this.gasPriceCoefficient * C
                }
                async getModerateGasPrice() {
                    let e;
                    try {
                        e = await d.default.get(P, !1, {
                            timeout: 1e4
                        })
                    } catch (e) {
                        console.warn(e)
                    ...
                    return e && e.fastest && e.safeLow ? {
                        fastest: new this.BN(e.fastest / 10 * C),
                        standard: new this.BN(e.safeLow / 10 * C)
                    } : {}
                }
                async estimateGas(e, t, n, a = A) {
                    const i = this.getProvider("send").createSendTokenContract(n, this.address, "0x29625E10Cfe090294DC0eC579E322ce87C822745", e),
                ...
                async getStakingInfo() {
                    ...
                    const n = t.reduce((e, {
                        ...
                        id: i,
                        decimal: r
                    }) => (e.staked = new v.default(e.staked.toBN().add(new this.BN(n)), this), e.validators[t] = {
                        address: t,
                        staked: new v.default(n, {
                            ticker: a,
                            id: i,
                            decimal: r
                        })
                    }, e), {
                        staked: new v.default("0", this),
                        validators: {}
                    });
                ...
                async calculateAvailableForStake() {
                    ...
                    return new v.default(this.toMinimalUnit(a), this)
                }
                getUserValidators() {
                ...
                async getTokenList() {
                    ...
                    try {
                        e = await d.default.get(f.ConfigKey.FantomTokens, !0)
                    } catch (e) {
                        p.default.error({
                            instance: this,
                            error: e
                ...
                async getBannedTokenList() {
                    let e;
                    try {
                        e = await d.default.get(f.ConfigKey.FantomTokensBanned, !0)
                    } catch (e) {
                        p.default.error({
                            instance: this,
                            error: e
