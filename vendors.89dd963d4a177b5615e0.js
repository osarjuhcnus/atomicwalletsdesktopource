    ...
    [313], {
        5478: function(t, i, r) {
            ...
            t.exports = {
                ...
                checkArgumentType: function(t, i, r) {
                    if (r = r || "(unknown name)", n.isString(i)) {
                        if ("Buffer" === i) {
                            if (!Buffer.isBuffer(t)) throw new e.InvalidArgumentType(t, i, r)
                        } else if (typeof t !== i) throw new e.InvalidArgumentType(t, i, r)
                    } else if (!(t instanceof i)) throw new e.InvalidArgumentType(t, i.name, r)
                }
            }
        },
        5484: function(t, i, r) {
            ...
            t.exports = {
                ...
                isUnsignedInteger: function(t) {
                    return "number" == typeof t && !isNaN(t) && t >= 0 && t === parseInt(t, 10)
                },
                isSha256HexString: function(t) {
                    return h(t) && t.length === 2 * n.SHA256_HASH_SIZE
                },
                isHexStringOfSize: function(t, i) {
                    return h(t) && t.length === i
                }
            }
        },
        5503: function(t, i, r) {
            ...
            t.exports = {
                fill: function(t, i) {
                    h.checkArgumentType(t, "Buffer", "buffer"), h.checkArgumentType(i, "number", "value");
                ...
                emptyBuffer: function(t) {
                    h.checkArgumentType(t, "number", "bytes");
                ...
                integerAsSingleByteBuffer: function(t) {
                    return h.checkArgumentType(t, "number", "integer"), Buffer.from([255 & t])
                },
                integerAsBuffer: function(t) {
                    h.checkArgumentType(t, "number", "integer");
                    var i = [];
                    return i.push(t >> 24 & 255), i.push(t >> 16 & 255), i.push(t >> 8 & 255), i.push(255 & t), Buffer.from(i)
                },
                integerFromBuffer: function(t) {
                    return h.checkArgumentType(t, "Buffer", "buffer"), t[0] << 24 | t[1] << 16 | t[2] << 8 | t[3]
                },
                integerFromSingleByteBuffer: function(t) {
                    return h.checkArgumentType(t, "Buffer", "buffer"), t[0]
                },
                bufferToHex: function(t) {
                    return h.checkArgumentType(t, "Buffer", "buffer"), t.toString("hex")
                },
                reverse: function(t) {
                    for (var i = Buffer.alloc(t.length), r = 0; r < t.length; r++) i[r] = t[t.length - r - 1];
                    return i
                },
                hexToBuffer: function(t) {
                    return e(n.isHexa(t)), Buffer.from(t, "hex")
                }
            ...
            (function(t) {
                ! function(t, i) {
                    ...
                    var d = function(t, i, r) {
                        ...
                        var Mt = (a + (e = Math.imul(f, z)) | 0) + ((8191 & (n = (n = Math.imul(f, H)) + Math.imul(m, z) | 0)) << 13) | 0;
                        a = ((h = Math.imul(m, H)) + (n >>> 13) | 0) + (Mt >>> 26) | 0, Mt &= 67108863, e = Math.imul(p, z), n = (n = Math.imul(p, H)) + Math.imul(c, z) | 0, h = Math.imul(c, H);
                        var gt = (a + (e = e + Math.imul(f, D) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(f, J) | 0) + Math.imul(m, D) | 0)) << 13) | 0;
                        a = ((h = h + Math.imul(m, J) | 0) + (n >>> 13) | 0) + (gt >>> 26) | 0, gt &= 67108863, e = Math.imul(g, z), n = (n = Math.imul(g, H)) + Math.imul(v, z) | 0, h = Math.imul(v, H), e = e + Math.imul(p, D) | 0, n = (n = n + Math.imul(p, J) | 0) + Math.imul(c, D) | 0, h = h + Math.imul(c, J) | 0;
                        var vt = (a + (e = e + Math.imul(f, K) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(f, Y) | 0) + Math.imul(m, K) | 0)) << 13) | 0;
                        a = ((h = h + Math.imul(m, Y) | 0) + (n >>> 13) | 0) + (vt >>> 26) | 0, vt &= 67108863, e = Math.imul(y, z), n = (n = Math.imul(y, H)) + Math.imul(b, z) | 0, h = Math.imul(b, H), e = e + Math.imul(g, D) | 0, n = (n = n + Math.imul(g, J) | 0) + Math.imul(v, D) | 0, h = h + Math.imul(v, J) | 0, e = e + Math.imul(p, K) | 0, n = (n = n + Math.imul(p, Y) | 0) + Math.imul(c, K) | 0, h = h + Math.imul(c, Y) | 0;
                        var wt = (a + (e = e + Math.imul(f, G) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(f, Q) | 0) + Math.imul(m, G) | 0)) << 13) | 0;
                        a = ((h = h + Math.imul(m, Q) | 0) + (n >>> 13) | 0) + (wt >>> 26) | 0, wt &= 67108863, e = Math.imul(B, z), n = (n = Math.imul(B, H)) + Math.imul(A, z) | 0, h = Math.imul(A, H), e = e + Math.imul(y, D) | 0, n = (n = n + Math.imul(y, J) | 0) + Math.imul(b, D) | 0, h = h + Math.imul(b, J) | 0, e = e + Math.imul(g, K) | 0, n = (n = n + Math.imul(g, Y) | 0) + Math.imul(v, K) | 0, h = h + Math.imul(v, Y) | 0, e = e + Math.imul(p, G) | 0, n = (n = n + Math.imul(p, Q) | 0) + Math.imul(c, G) | 0, h = h + Math.imul(c, Q) | 0;
                        var yt = (a + (e = e + Math.imul(f, X) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(f, tt) | 0) + Math.imul(m, X) | 0)) << 13) | 0;
                        a = ((h = h + Math.imul(m, tt) | 0) + (n >>> 13) | 0) + (yt >>> 26) | 0, yt &= 67108863, e = Math.imul(x, z), n = (n = Math.imul(x, H)) + Math.imul(k, z) | 0, h = Math.imul(k, H), e = e + Math.imul(B, D) | 0, n = (n = n + Math.imul(B, J) | 0) + Math.imul(A, D) | 0, h = h + Math.imul(A, J) | 0, e = e + Math.imul(y, K) | 0, n = (n = n + Math.imul(y, Y) | 0) + Math.imul(b, K) | 0, h = h + Math.imul(b, Y) | 0, e = e + Math.imul(g, G) | 0, n = (n = n + Math.imul(g, Q) | 0) + Math.imul(v, G) | 0, h = h + Math.imul(v, Q) | 0, e = e + Math.imul(p, X) | 0, n = (n = n + Math.imul(p, tt) | 0) + Math.imul(c, X) | 0, h = h + Math.imul(c, tt) | 0;
                        var bt = (a + (e = e + Math.imul(f, rt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(f, et) | 0) + Math.imul(m, rt) | 0)) << 13) | 0;
                        a = ((h = h + Math.imul(m, et) | 0) + (n >>> 13) | 0) + (bt >>> 26) | 0, bt &= 67108863, e = Math.imul(I, z), n = (n = Math.imul(I, H)) + Math.imul(R, z) | 0, h = Math.imul(R, H), e = e + Math.imul(x, D) | 0, n = (n = n + Math.imul(x, J) | 0) + Math.imul(k, D) | 0, h = h + Math.imul(k, J) | 0, e = e + Math.imul(B, K) | 0, n = (n = n + Math.imul(B, Y) | 0) + Math.imul(A, K) | 0, h = h + Math.imul(A, Y) | 0, e = e + Math.imul(y, G) | 0, n = (n = n + Math.imul(y, Q) | 0) + Math.imul(b, G) | 0, h = h + Math.imul(b, Q) | 0, e = e + Math.imul(g, X) | 0, n = (n = n + Math.imul(g, tt) | 0) + Math.imul(v, X) | 0, h = h + Math.imul(v, tt) | 0, e = e + Math.imul(p, rt) | 0, n = (n = n + Math.imul(p, et) | 0) + Math.imul(c, rt) | 0, h = h + Math.imul(c, et) | 0;
                        var _t = (a + (e = e + Math.imul(f, ht) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(f, ot) | 0) + Math.imul(m, ht) | 0)) << 13) | 0;
                        a = ((h = h + Math.imul(m, ot) | 0) + (n >>> 13) | 0) + (_t >>> 26) | 0, _t &= 67108863, e = Math.imul(N, z), n = (n = Math.imul(N, H)) + Math.imul(O, z) | 0, h = Math.imul(O, H), e = e + Math.imul(I, D) | 0, n = (n = n + Math.imul(I, J) | 0) + Math.imul(R, D) | 0, h = h + Math.imul(R, J) | 0, e = e + Math.imul(x, K) | 0, n = (n = n + Math.imul(x, Y) | 0) + Math.imul(k, K) | 0, h = h + Math.imul(k, Y) | 0, e = e + Math.imul(B, G) | 0, n = (n = n + Math.imul(B, Q) | 0) + Math.imul(A, G) | 0, h = h + Math.imul(A, Q) | 0, e = e + Math.imul(y, X) | 0, n = (n = n + Math.imul(y, tt) | 0) + Math.imul(b, X) | 0, h = h + Math.imul(b, tt) | 0, e = e + Math.imul(g, rt) | 0, n = (n = n + Math.imul(g, et) | 0) + Math.imul(v, rt) | 0, h = h + Math.imul(v, et) | 0, e = e + Math.imul(p, ht) | 0, n = (n = n + Math.imul(p, ot) | 0) + Math.imul(c, ht) | 0, h = h + Math.imul(c, ot) | 0;
                        var Bt = (a + (e = e + Math.imul(f, ut) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(f, at) | 0) + Math.imul(m, ut) | 0)) << 13) | 0;
                        a = ((h = h + Math.imul(m, at) | 0) + (n >>> 13) | 0) + (Bt >>> 26) | 0, Bt &= 67108863, e = Math.imul(Z, z), n = (n = Math.imul(Z, H)) + Math.imul(P, z) | 0, h = Math.imul(P, H), e = e + Math.imul(N, D) | 0, n = (n = n + Math.imul(N, J) | 0) + Math.imul(O, D) | 0, h = h + Math.imul(O, J) | 0, e = e + Math.imul(I, K) | 0, n = (n = n + Math.imul(I, Y) | 0) + Math.imul(R, K) | 0, h = h + Math.imul(R, Y) | 0, e = e + Math.imul(x, G) | 0, n = (n = n + Math.imul(x, Q) | 0) + Math.imul(k, G) | 0, h = h + Math.imul(k, Q) | 0, e = e + Math.imul(B, X) | 0, n = (n = n + Math.imul(B, tt) | 0) + Math.imul(A, X) | 0, h = h + Math.imul(A, tt) | 0, e = e + Math.imul(y, rt) | 0, n = (n = n + Math.imul(y, et) | 0) + Math.imul(b, rt) | 0, h = h + Math.imul(b, et) | 0, e = e + Math.imul(g, ht) | 0, n = (n = n + Math.imul(g, ot) | 0) + Math.imul(v, ht) | 0, h = h + Math.imul(v, ot) | 0, e = e + Math.imul(p, ut) | 0, n = (n = n + Math.imul(p, at) | 0) + Math.imul(c, ut) | 0, h = h + Math.imul(c, at) | 0;
                        var At = (a + (e = e + Math.imul(f, ft) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(f, mt) | 0) + Math.imul(m, ft) | 0)) << 13) | 0;
                        a = ((h = h + Math.imul(m, mt) | 0) + (n >>> 13) | 0) + (At >>> 26) | 0, At &= 67108863, e = Math.imul(C, z), n = (n = Math.imul(C, H)) + Math.imul(U, z) | 0, h = Math.imul(U, H), e = e + Math.imul(Z, D) | 0, n = (n = n + Math.imul(Z, J) | 0) + Math.imul(P, D) | 0, h = h + Math.imul(P, J) | 0, e = e + Math.imul(N, K) | 0, n = (n = n + Math.imul(N, Y) | 0) + Math.imul(O, K) | 0, h = h + Math.imul(O, Y) | 0, e = e + Math.imul(I, G) | 0, n = (n = n + Math.imul(I, Q) | 0) + Math.imul(R, G) | 0, h = h + Math.imul(R, Q) | 0, e = e + Math.imul(x, X) | 0, n = (n = n + Math.imul(x, tt) | 0) + Math.imul(k, X) | 0, h = h + Math.imul(k, tt) | 0, e = e + Math.imul(B, rt) | 0, n = (n = n + Math.imul(B, et) | 0) + Math.imul(A, rt) | 0, h = h + Math.imul(A, et) | 0, e = e + Math.imul(y, ht) | 0, n = (n = n + Math.imul(y, ot) | 0) + Math.imul(b, ht) | 0, h = h + Math.imul(b, ot) | 0, e = e + Math.imul(g, ut) | 0, n = (n = n + Math.imul(g, at) | 0) + Math.imul(v, ut) | 0, h = h + Math.imul(v, at) | 0, e = e + Math.imul(p, ft) | 0, n = (n = n + Math.imul(p, mt) | 0) + Math.imul(c, ft) | 0, h = h + Math.imul(c, mt) | 0;
                        var St = (a + (e = e + Math.imul(f, pt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(f, ct) | 0) + Math.imul(m, pt) | 0)) << 13) | 0;
                        a = ((h = h + Math.imul(m, ct) | 0) + (n >>> 13) | 0) + (St >>> 26) | 0, St &= 67108863, e = Math.imul(C, D), n = (n = Math.imul(C, J)) + Math.imul(U, D) | 0, h = Math.imul(U, J), e = e + Math.imul(Z, K) | 0, n = (n = n + Math.imul(Z, Y) | 0) + Math.imul(P, K) | 0, h = h + Math.imul(P, Y) | 0, e = e + Math.imul(N, G) | 0, n = (n = n + Math.imul(N, Q) | 0) + Math.imul(O, G) | 0, h = h + Math.imul(O, Q) | 0, e = e + Math.imul(I, X) | 0, n = (n = n + Math.imul(I, tt) | 0) + Math.imul(R, X) | 0, h = h + Math.imul(R, tt) | 0, e = e + Math.imul(x, rt) | 0, n = (n = n + Math.imul(x, et) | 0) + Math.imul(k, rt) | 0, h = h + Math.imul(k, et) | 0, e = e + Math.imul(B, ht) | 0, n = (n = n + Math.imul(B, ot) | 0) + Math.imul(A, ht) | 0, h = h + Math.imul(A, ot) | 0, e = e + Math.imul(y, ut) | 0, n = (n = n + Math.imul(y, at) | 0) + Math.imul(b, ut) | 0, h = h + Math.imul(b, at) | 0, e = e + Math.imul(g, ft) | 0, n = (n = n + Math.imul(g, mt) | 0) + Math.imul(v, ft) | 0, h = h + Math.imul(v, mt) | 0;
                        var xt = (a + (e = e + Math.imul(p, pt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(p, ct) | 0) + Math.imul(c, pt) | 0)) << 13) | 0;
                        a = ((h = h + Math.imul(c, ct) | 0) + (n >>> 13) | 0) + (xt >>> 26) | 0, xt &= 67108863, e = Math.imul(C, K), n = (n = Math.imul(C, Y)) + Math.imul(U, K) | 0, h = Math.imul(U, Y), e = e + Math.imul(Z, G) | 0, n = (n = n + Math.imul(Z, Q) | 0) + Math.imul(P, G) | 0, h = h + Math.imul(P, Q) | 0, e = e + Math.imul(N, X) | 0, n = (n = n + Math.imul(N, tt) | 0) + Math.imul(O, X) | 0, h = h + Math.imul(O, tt) | 0, e = e + Math.imul(I, rt) | 0, n = (n = n + Math.imul(I, et) | 0) + Math.imul(R, rt) | 0, h = h + Math.imul(R, et) | 0, e = e + Math.imul(x, ht) | 0, n = (n = n + Math.imul(x, ot) | 0) + Math.imul(k, ht) | 0, h = h + Math.imul(k, ot) | 0, e = e + Math.imul(B, ut) | 0, n = (n = n + Math.imul(B, at) | 0) + Math.imul(A, ut) | 0, h = h + Math.imul(A, at) | 0, e = e + Math.imul(y, ft) | 0, n = (n = n + Math.imul(y, mt) | 0) + Math.imul(b, ft) | 0, h = h + Math.imul(b, mt) | 0;
                        var kt = (a + (e = e + Math.imul(g, pt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(g, ct) | 0) + Math.imul(v, pt) | 0)) << 13) | 0;
                        a = ((h = h + Math.imul(v, ct) | 0) + (n >>> 13) | 0) + (kt >>> 26) | 0, kt &= 67108863, e = Math.imul(C, G), n = (n = Math.imul(C, Q)) + Math.imul(U, G) | 0, h = Math.imul(U, Q), e = e + Math.imul(Z, X) | 0, n = (n = n + Math.imul(Z, tt) | 0) + Math.imul(P, X) | 0, h = h + Math.imul(P, tt) | 0, e = e + Math.imul(N, rt) | 0, n = (n = n + Math.imul(N, et) | 0) + Math.imul(O, rt) | 0, h = h + Math.imul(O, et) | 0, e = e + Math.imul(I, ht) | 0, n = (n = n + Math.imul(I, ot) | 0) + Math.imul(R, ht) | 0, h = h + Math.imul(R, ot) | 0, e = e + Math.imul(x, ut) | 0, n = (n = n + Math.imul(x, at) | 0) + Math.imul(k, ut) | 0, h = h + Math.imul(k, at) | 0, e = e + Math.imul(B, ft) | 0, n = (n = n + Math.imul(B, mt) | 0) + Math.imul(A, ft) | 0, h = h + Math.imul(A, mt) | 0;
                        var Tt = (a + (e = e + Math.imul(y, pt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(y, ct) | 0) + Math.imul(b, pt) | 0)) << 13) | 0;
                        a = ((h = h + Math.imul(b, ct) | 0) + (n >>> 13) | 0) + (Tt >>> 26) | 0, Tt &= 67108863, e = Math.imul(C, X), n = (n = Math.imul(C, tt)) + Math.imul(U, X) | 0, h = Math.imul(U, tt), e = e + Math.imul(Z, rt) | 0, n = (n = n + Math.imul(Z, et) | 0) + Math.imul(P, rt) | 0, h = h + Math.imul(P, et) | 0, e = e + Math.imul(N, ht) | 0, n = (n = n + Math.imul(N, ot) | 0) + Math.imul(O, ht) | 0, h = h + Math.imul(O, ot) | 0, e = e + Math.imul(I, ut) | 0, n = (n = n + Math.imul(I, at) | 0) + Math.imul(R, ut) | 0, h = h + Math.imul(R, at) | 0, e = e + Math.imul(x, ft) | 0, n = (n = n + Math.imul(x, mt) | 0) + Math.imul(k, ft) | 0, h = h + Math.imul(k, mt) | 0;
                        var It = (a + (e = e + Math.imul(B, pt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(B, ct) | 0) + Math.imul(A, pt) | 0)) << 13) | 0;
                        a = ((h = h + Math.imul(A, ct) | 0) + (n >>> 13) | 0) + (It >>> 26) | 0, It &= 67108863, e = Math.imul(C, rt), n = (n = Math.imul(C, et)) + Math.imul(U, rt) | 0, h = Math.imul(U, et), e = e + Math.imul(Z, ht) | 0, n = (n = n + Math.imul(Z, ot) | 0) + Math.imul(P, ht) | 0, h = h + Math.imul(P, ot) | 0, e = e + Math.imul(N, ut) | 0, n = (n = n + Math.imul(N, at) | 0) + Math.imul(O, ut) | 0, h = h + Math.imul(O, at) | 0, e = e + Math.imul(I, ft) | 0, n = (n = n + Math.imul(I, mt) | 0) + Math.imul(R, ft) | 0, h = h + Math.imul(R, mt) | 0;
                        var Rt = (a + (e = e + Math.imul(x, pt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(x, ct) | 0) + Math.imul(k, pt) | 0)) << 13) | 0;
                        a = ((h = h + Math.imul(k, ct) | 0) + (n >>> 13) | 0) + (Rt >>> 26) | 0, Rt &= 67108863, e = Math.imul(C, ht), n = (n = Math.imul(C, ot)) + Math.imul(U, ht) | 0, h = Math.imul(U, ot), e = e + Math.imul(Z, ut) | 0, n = (n = n + Math.imul(Z, at) | 0) + Math.imul(P, ut) | 0, h = h + Math.imul(P, at) | 0, e = e + Math.imul(N, ft) | 0, n = (n = n + Math.imul(N, mt) | 0) + Math.imul(O, ft) | 0, h = h + Math.imul(O, mt) | 0;
                        var Et = (a + (e = e + Math.imul(I, pt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(I, ct) | 0) + Math.imul(R, pt) | 0)) << 13) | 0;
                        a = ((h = h + Math.imul(R, ct) | 0) + (n >>> 13) | 0) + (Et >>> 26) | 0, Et &= 67108863, e = Math.imul(C, ut), n = (n = Math.imul(C, at)) + Math.imul(U, ut) | 0, h = Math.imul(U, at), e = e + Math.imul(Z, ft) | 0, n = (n = n + Math.imul(Z, mt) | 0) + Math.imul(P, ft) | 0, h = h + Math.imul(P, mt) | 0;
                        var Nt = (a + (e = e + Math.imul(N, pt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(N, ct) | 0) + Math.imul(O, pt) | 0)) << 13) | 0;
                        a = ((h = h + Math.imul(O, ct) | 0) + (n >>> 13) | 0) + (Nt >>> 26) | 0, Nt &= 67108863, e = Math.imul(C, ft), n = (n = Math.imul(C, mt)) + Math.imul(U, ft) | 0, h = Math.imul(U, mt);
                        var Ot = (a + (e = e + Math.imul(Z, pt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(Z, ct) | 0) + Math.imul(P, pt) | 0)) << 13) | 0;
                        a = ((h = h + Math.imul(P, ct) | 0) + (n >>> 13) | 0) + (Ot >>> 26) | 0, Ot &= 67108863;
                        var qt = (a + (e = Math.imul(C, pt)) | 0) + ((8191 & (n = (n = Math.imul(C, ct)) + Math.imul(U, pt) | 0)) << 13) | 0;
                        return a = ((h = Math.imul(U, ct)) + (n >>> 13) | 0) + (qt >>> 26) | 0, qt &= 67108863, u[0] = Mt, u[1] = gt, u[2] = vt, u[3] = wt, u[4] = yt, u[5] = bt, u[6] = _t, u[7] = Bt, u[8] = At, u[9] = St, u[10] = xt, u[11] = kt, u[12] = Tt, u[13] = It, u[14] = Rt, u[15] = Et, u[16] = Nt, u[17] = Ot, u[18] = qt, 0 !== a && (u[19] = a, r.length++), r
                    };
        ...
        6553: function(t, i, r) {
            var e = r(5507),
                n = r(5515),
                h = r(5540),
                o = /^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5]):[0-9]+$/,
                s = Buffer.from("00000000000000000000ffff", "hex"),
                u = Buffer.alloc(18),
                a = h.EMPTY_IPV6_ADDRESS,
                l = h.EMPTY_IPV4_ADDRESS;
            ...
            var d = {
                isIPV4: f,
                ipAndPortToBuffer: function(t) {
                    if (m(t)) return u.slice();
                    if (!f(t)) throw new Error("Only serialization of ipv4 and zero ipv6 is allowed");
                    var i = t.split(":"),
                        r = i[0].split(".").map((function(t) {
                            return Number(t)
                        })),
                        n = Number(i[1]),
                        h = new e;
                    return h.write(s), h.write(Buffer.from(r)), h.writeUInt16BE(n), h.toBuffer()
                },
                bufferToIPAndPort: function(t) {
                    if (18 !== t.length) throw new Error("Ip buffer has wrong size. Expected size is 18 bytes");
                    var i = new n(t),
                        r = i.read(h.IP_ADDRESS_SIZE),
                        e = i.readUInt16BE(),
                        o = Array.prototype.slice.call(r.slice(12, 16)).join(".") + ":" + String(e);
                    return o = m(o) ? a : o
                },
                isZeroAddress: m,
                IP_AND_PORT_SIZE: h.ipAddresses.IPV4MAPPEDHOST + h.ipAddresses.PORT
            };
            t.exports = d
        },
        7289: function(t, i, r) {
            var e = r(5541).sha256sha256;
            t.exports = {
                getMerkleTree: function(t) {
                    for (var i = t.map(Buffer.from), r = 0, n = t.length; n > 1; n = Math.floor((n + 1) / 2)) {
                        for (var h = 0; h < n; h += 2) {
                            var o = Math.min(h + 1, n - 1),
                                s = Buffer.concat([i[r + h], i[r + o]]);
                            i.push(Buffer.from(e(s), "hex"))
                        }
                        r += n
                    }
                    return i
                },
                getMerkleRoot: function(t) {
                    if (0 !== t.length) return Buffer.from(t[t.length - 1])
                }
            }
        },
        9563: function(t, i, r) {
            var e = r(5541),
                n = {
                    getRandomHashHexString: function() {
                        return e.sha256sha256(Buffer.from(Math.random().toString())).toString("hex")
                    }
                };
            t.exports = n
        },
        9570: function(t, i, r) {
            ...
            s.fromString = function(t) {
                ...
                var i = n.parse(t, !0);
                if ("dash:" !== i.protocol) throw new TypeError("Invalid dash URI");
                var r = /[^:]*:\/?\/?([^?]*)/.exec(t);
                return i.query.address = r && r[1] || void 0, i.query
            }, s.Members = ["address", "amount", "message", "label", "r"], s.prototype._fromObject = function(t) {
                if (!h.isValid(t.address)) throw new TypeError("Invalid dash address");
