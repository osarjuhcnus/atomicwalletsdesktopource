            ...
            e.exports = function e(t, r, n) {
                function i(s, a) {
                    if (!r[s]) {
                        if (!t[s]) {
                            var u = !1;
                            if (!a && u) return (void 0)(s, !0);
                            if (o) return o(s, !0);
                            throw (u = new Error("Cannot find module '" + s + "'")).code = "MODULE_NOT_FOUND", u
                        }
                        u = r[s] = {
                            exports: {}
                ...
                47: [function(e, t, r) {
                    (function(e) {
                        (function() {
                            var r, n, i;
                            e.crypto && crypto.getRandomValues && (r = new Uint8Array(16), n = function() {
                ...
                51: [function(e, t, r) {
                    ...
                    i(K, D = v.Provider), K.prototype._doPoll = function() {
                        var e = this;
                        ...
                        return this.ready.then((function() {
                            return c.resolveProperties(e).then((function(e) {
                                return t._resolveNames(e, ["address"]).then((function(e) {
                                    return e = {
                                        filter: (e = e) && e.blockHash ? b(F, e) : b(U, e)
                    ...
                    }, K.checkTransactionResponse = N, K.prototype.doPoll = function() {}, K.prototype.perform = function(e, t) {
                    ...
                    }, K.prototype._stopPending = function() {}, K.prototype._addEventListener = function(e, t, r) {
                        this._events.push({
                            tag: z(e),
                            listener: t,
                            once: r
                    ...
                    }, i = K, r.BaseProvider = i, c.defineReadOnly(v.Provider, "inherits", c.inheritable(v.Provider))
                }, {
                    "../constants": 3,
                    "../errors": 5,
                    "../utils/address": 60,
                ...
                52: [function(e, t, r) {
                    ...
                    function c(e) {
                        var t, r, n = [];
                        for (t in e) null != e[t] && (r = u.hexlify(e[t]), {
                            gasLimit: !0,
                            gasPrice: !0,
                            nonce: !0,
                            value: !0
                        } [t] && (r = u.hexStripZeros(r)), n.push(t + "=" + r));
                        return n.join("&")
                    }
                    ...
                    function m(e, t) {
                        ...
                        return l.defineReadOnly(r, "baseUrl", n), l.defineReadOnly(r, "apiKey", t || "8FG3JMZ9USS4NTA6YKEKHINU56SEPPVBJR"), r
                    }
                    i(m, s = a.BaseProvider), m.prototype.perform = function(e, t) {
                        var r, n = this,
                            i = this.baseUrl,
                            o = "";

                        function a(e, t) {
                            return h.fetchJson(e, null, t || p).then((function(t) {
                                return n.emit("debug", {
                                    action: "perform",
                                    request: e,
                                    response: t,
                        ...
                        switch (this.apiKey && (o += "&apikey=" + this.apiKey), e) {
                            case "getBlockNumber":
                                return a(i += "/api?module=proxy&action=eth_blockNumber" + o);
                            case "getGasPrice":
                                return a(i += "/api?module=proxy&action=eth_gasPrice" + o);
                            case "getBalance":
                                return i += "/api?module=account&action=balance&address=" + t.address, a(i += "&tag=" + t.blockTag + o, d);
                            case "getTransactionCount":
                                return i += "/api?module=proxy&action=eth_getTransactionCount&address=" + t.address, a(i += "&tag=" + t.blockTag + o);
                            case "getCode":
                                return i += "/api?module=proxy&action=eth_getCode&address=" + t.address, a(i += "&tag=" + t.blockTag + o, p);
                            case "getStorageAt":
                                return i += "/api?module=proxy&action=eth_getStorageAt&address=" + t.address, i += "&position=" + t.position, a(i += "&tag=" + t.blockTag + o, p);
                            case "sendTransaction":
                                return i += "/api?module=proxy&action=eth_sendRawTransaction&hex=" + t.signedTransaction, a(i += o).catch((function(e) {
                                    throw e.responseText && (0 <= e.responseText.toLowerCase().indexOf("insufficient funds") && f.throwError("insufficient funds", f.INSUFFICIENT_FUNDS, {}), 0 <= e.responseText.indexOf("same hash was already imported") && f.throwError("nonce has already been used", f.NONCE_EXPIRED, {}), 0 <= e.responseText.indexOf("another transaction with same nonce") && f.throwError("replacement fee too low", f.REPLACEMENT_UNDERPRICED, {})), e
                                }));
                            case "getBlock":
                                return t.blockTag ? (i += "/api?module=proxy&action=eth_getBlockByNumber&tag=" + t.blockTag, t.includeTransactions ? i += "&boolean=true" : i += "&boolean=false", a(i += o)) : Promise.reject(new Error("getBlock by blockHash not implemeneted"));
                            case "getTransaction":
                                return i += "/api?module=proxy&action=eth_getTransactionByHash&txhash=" + t.transactionHash, a(i += o);
                            case "getTransactionReceipt":
                                return i += "/api?module=proxy&action=eth_getTransactionReceipt&txhash=" + t.transactionHash, a(i += o);
                            case "call":
                                return i += "/api?module=proxy&action=eth_call" + (r = (r = c(t.transaction)) && "&" + r), "latest" !== t.blockTag ? Promise.reject(new Error("EtherscanProvider does not support blockTag for call")) : a(i += o);
                            case "estimateGas":
                                return i += "/api?module=proxy&action=eth_estimateGas&" + (r = (r = c(t.transaction)) && "&" + r), a(i += o);
                            case "getLogs":
                                i += "/api?module=logs&action=getLogs";
                                try {
                                    if (t.filter.fromBlock && (i += "&fromBlock=" + y(t.filter.fromBlock)), t.filter.toBlock && (i += "&toBlock=" + y(t.filter.toBlock)), t.filter.blockHash) try {
                                        f.throwError("Etherscan does not support blockHash filters", f.UNSUPPORTED_OPERATION, {
                                    ...
                                    if (t.filter.address && (i += "&address=" + t.filter.address), t.filter.topics && 0 < t.filter.topics.length) {
                                        ...
                                        var u = t.filter.topics[0];
                                        if ("string" != typeof u || 66 !== u.length) throw new Error("unsupported topic0 format");
                                        i += "&topic0=" + u
                                    }
                                } catch (e) {
                                    return Promise.reject(e)
                                ...
                                var l = this;
                                return a(i += o, d).then((function(e) {
                                    var t = {},
                                        r = Promise.resolve();
                                    return e.forEach((function(e) {
                                        r = r.then((function() {
                                            return null != e.blockHash ? null : (e.blockHash = t[e.transactionHash], null == e.blockHash ? l.getTransaction(e.transactionHash).then((function(r) {
                            ...
                            case "getEtherPrice":
                                return "homestead" !== this.network.name ? Promise.resolve(0) : (i += "/api?module=stats&action=ethprice", a(i += o, d).then((function(e) {
                                    return parseFloat(e.ethusd)
                                })))
                        }
                        return s.prototype.perform.call(this, e, t)
                        ...
                        return this.apiKey && (o += "&apikey=" + this.apiKey), null == t && (t = 0), null == r && (r = 99999999), this.resolveName(e).then((function(e) {
                            return i += "/api?module=account&action=txlist&address=" + e, i += "&startblock=" + t, i += "&endblock=" + r, i += "&sort=asc" + o, h.fetchJson(i, null, d).then((function(e) {
                                n.emit("debug", {
                                    action: "getHistory",
                                    request: i,
                                    response: e,
                                ...
                                return e.forEach((function(e) {
                                    ...
                                    var r = a.BaseProvider.checkTransactionResponse(e);
                                    e.timeStamp && (r.timestamp = parseInt(e.timeStamp)), t.push(r)
                                })), t
                            }))
                        }))
                    }, i = m, r.EtherscanProvider = i
                }, {
                    "../errors": 5,
                    "../utils/bytes": 64,
                    "../utils/properties": 74,
                ...
                55: [function(e, t, r) {
                    ...
                    function c(e, t) {
                        ...
                        return u.isHexString("0x" + t, 16) ? (r = s.call(this, "https://" + i + "/v3/" + t, n) || this, h.defineReadOnly(r, "apiAccessToken", null), h.defineReadOnly(r, "projectId", t)) : (f.warn("The legacy INFURA apiAccesToken API is deprecated; please upgrade to a Project ID instead (see INFURA dshboard; https://infura.io)"), r = s.call(this, "https://" + i + "/" + t, n) || this, h.defineReadOnly(r, "apiAccessToken", t), h.defineReadOnly(r, "projectId", null)), f.checkNew(r, c), r
                    }
                    i(c, s = a.JsonRpcProvider), c.prototype._startPending = function() {
                        f.warn("WARNING: INFURA does not support pending filters")
                    }, c.prototype.getSigner = function(e) {
                        return f.throwError("INFURA does not support signing", f.UNSUPPORTED_OPERATION, {
                            operation: "getSigner"
                        })
                    }, c.prototype.listAccounts = function() {
                        return Promise.resolve([])
                    }, i = c, r.InfuraProvider = i
                }, {
                    "../errors": 5,
                    "../utils/bytes": 64,
                    "../utils/networks": 72,
                ...
                69: [function(e, t, r) {
                    ...
                    function C(e) {
                        if (p.checkNew(this, C), "string" == typeof e) {
                            try {
                                e = JSON.parse(e)
                            } catch (t) {
                            ...
                            if (!Array.isArray(e)) return p.throwError("invalid abi", p.INVALID_ARGUMENT, {
                                arg: "abi",
                                value: e
                            }), null
                        }
                        ...
                        e.forEach((function(e) {
                            "string" == typeof e && (e = u.parseSignature(e)), t.push(e)
                        })), d.defineReadOnly(this, "abi", d.deepCopy(t, !0)), t.forEach(O, this), this.deployFunction || O.call(this, {
                            type: "constructor",
                            inputs: []
                    ...
                    (function(t) {
                        (function() {
                            ...
                            function s(e) {
                                ...
                                return e = new Uint8Array(e), o.getRandomValues(e), n.arrayify(e)
                            }
                            o && o.getRandomValues || (console.log("WARNING: Missing strong random number source; using weak randomBytes"), o = {
                                ...
                                _weakCrypto: !0
                            }), r.randomBytes = s, !0 === o._weakCrypto && i.defineReadOnly(s, "_weakCrypto", !0)
                        }).call(this)
                    }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
                }, {
                    "../utils/bytes": 64,
                ...
                78: [function(e, t, r) {
                    ...
                    r.decryptCrowdsale = function(e, t) {
                        ...
                        var m = (m = r.client) || "ethers.js",
                            b = r.salt ? f.arrayify(r.salt) : y.randomBytes(32),
                            w = null;
                        if (r.iv) {
                ...
                82: [function(e, t, r) {
                    ...
                    function f(e, t) {
                        ...
                        return e.forEach((function(e, s) {
                            r.push(function e(t, r, s) {
                                ...
                                var a = t.match(l);
                                if (a) {
                                    if ((f = parseInt(a[2] || "256")) % 8 != 0 || 0 === f || 256 < f) throw new Error("invalid number type - " + t);
                                    return s && (f = 256), r = n.bigNumberify(r).toTwos(f), i.padZeros(r, f / 8)
                                }
                                if (a = t.match(u)) {
                                    var f = parseInt(a[1]);
                                    if (String(f) != a[1] || 0 === f || 32 < f) throw new Error("invalid number type - " + t);
                                    if (i.arrayify(r).byteLength !== f) throw new Error("invalid value for " + t);
                    ...
                    r.pack = f, r.keccak256 = function(e, t) {
                ...
                87: [function(e, t, r) {
                    (function(t) {
                        (function() {
                            ...
                            r.Wordlist = i, r.register = function(e, t) {
                                t = t || e.locale
                            }
                        }).call(this)
                    }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
                ...
                90: [function(e, t, r) {
                    ...
                    i = new(i(l, o = s.Wordlist), l.prototype.getWord = function(e) {
                        return u(this), a[e]
                    }, l.prototype.getWordIndex = function(e) {
                        return u(this), a.indexOf(e)
                    }, l), r.langEn = i, s.register(i)
                }, {
                    "../utils/wordlist": 87
                }]
            }, {}, [7])(7)
