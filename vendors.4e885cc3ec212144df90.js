(window.webpackJsonp = window.webpackJsonp || []).push([
    [259], {
        5398: function(e, t, n) {
            ...
            const C = 1e9,
                B = "150000",
                A = "0x1D80c49BbBCd1C0911346656B529DF9E5c2F783d";
            var E = new WeakSet;
            class FLRCoin extends((0, T.StakingMixin)((0, T.Web3Mixin)((0, T.HasProviders)((0, T.HasTokensMixin)(o.default))))) {
                constructor({
                    alias: e,
                    notify: t,
                    feeData: n,
                    ...
                    super({
                        ...
                        socket: r,
                        feeData: n
                    }), k(this, E), this.gasLimit = n.gasLimit || "21000", this.stakingGasLimit = n.stakingGasLimit || B, this.autoClaimGasLimit = n.autoClaimGasLimit || "55000", this.stakingFeeMultiplier = 2, this.gasLimitCoefficient = n.gasLimitCoefficient, this.gasPriceCoefficient = n.gasPriceCoefficient, this.defaultGasPrice = new this.BN(n.defaultGasPrice * C), this.defaultMaxGasPrice = n.defaultMaxGasPrice, this.reservedForStake = n.reservedForStake || "50250000000000000", this.gasPriceConfig = null, this.bannedTokens = [], this.resendTimeout = n.resendTimeout, this.stakingContract = n.stakingContract || A, this.rewardsContract = n.rewardsContract || "0x85627d71921AE25769f5370E482AdA5E1e418d37";
                    const s = a.find(({
                        className: e
                    }) => "Web3Explorer" === e);
                    this.web3 = new y.Web3Explorer({
                ...
                async getTransactions() {
                    if (!this.address) throw new Error("FLR: getTransactions: address is not loaded");
                ...
                loadWallet(e) {
                    return new Promise(async (t, n) => {
                        ...
                        r ? (this.privateKey = r.privateKey, this.address = r.address, this.getNonce(), t(this)) : n(new Error("FLR cant get a wallet!"))
                    })
                }
                getAddress() {
                    try {
                ...
                async getMaxFeePerGas(e) {
                    ...
                    if (!t) throw new g.ExternalError({
                        type: v.EXTERNAL_ERROR,
                        error: "Failed to get getMaxFeePerGas",
                        instance: this
                    });
                    return t.mul(new s.default(e)).toString()
                }
                async estimateGasForSendNft(e, t, n, a, i = 1) {
                    try {
                        ...
                        throw console.warn(e), new g.ExternalError({
                            type: v.EXTERNAL_ERROR,
                            error: e,
                            instance: this
                        })
                ...
                async getNftTransferGasParams(e, t, {
                    ...
                    const {
                        ...
                        defaultGasPrice: l,
                        gasLimit: d = B
                    } = this, p = r || u, f = o || c, y = [new s.default(l).mul(new s.default(p)).toString(), Math.ceil(Number(d) * f).toString()], h = (await this.getNonce()).toNumber(), [m, b] = await Promise.allSettled([n || this.getMaxFeePerGas(p), a || this.estimateGasForSendNft(i, e, h, t, f)]).then(e => e.map((e, t) => "fulfilled" === e.status ? e.value : y[t]));
                    return {
                        gasLimit: b,
                        gasPrice: m,
                        nonce: h
                ...
                async getFee({
                    ...
                    const a = e || await this.getGasPrice();
                    return new s.default(String(a)).mul(new this.BN(t || this.gasLimit).mul(new this.BN(n)))
                }
                async getGasPrice(e = !1) {
                    if (e) return this.defaultGasPrice;
                    const t = new this.BN(this.gasPriceCoefficient),
                        n = new this.BN(Number(this.defaultGasPrice) / C).add(t);
                    return new this.BN(Number(n) * C)
                }
                async estimateGas(e, t, n, a = B) {
                    const i = this.getProvider("send").createSendTokenContract(n, this.address, "0xbdd5468D969e585E38B5a0EEADDb56D5B76814ff", e),
                        r = await this.coreLibrary.eth.estimateGas({
                            ...
                            to: n,
                            data: i
                        }).catch(e => h.default.error({
                            instance: this,
                            error: e
                        }));
                    return r ? Math.round(r * this.gasLimitCoefficient).toString() : a
                }
                ...
                async getTokenList() {
                    ...
                    try {
                        e = await m.default.get("flare-tokens", !0)
                    } catch (e) {
                        h.default.error({
                            instance: this,
                            error: e
                ...
                async getBannedTokenList() {
                    let e;
                    try {
                        e = await m.default.get("flare-tokens-banned", !0)
                    } catch (e) {
                        h.default.error({
                            instance: this,
                            error: e
                ...
                createDepositTransaction({
                    ...
                    const t = this.createSmartContractCall({
                ...
                async createStakeTransaction({
                    ...
                    const n = Object.keys(this.getValidators()).length > 0,
                        a = await this.createDepositTransaction({
                            amount: e
                        });
                    return n ? a : (await this.sendTransaction(a), await this.getNonce(), this.createDelegationTransaction({
                        validator: t
                    }))
                }
                ...
                createUndelegationTransaction() {
                    const e = this.createSmartContractCall({
                        smartContractAddress: this.stakingContract,
                        action: "undelegate",
                        args: []
                    });
                ...
                async createClaimTransaction({
                    ...
                    const {
                        manager: t,
                        address: n
                    } = await P(this, E, L).call(this), a = await t.methods.getEpochsWithUnclaimedRewards(e).call(), i = Math.max(...a) || 0, r = t.methods.claim(this.address, this.address, i, !0).encodeABI();
                    return this.createTransaction({
                        address: n,
                        paymentData: r,
                        amount: "0",
                ...
                calculateTotal({
                    ...
                    return new w.default(e.toBN().add(t.toBN()).add(n.toBN()), this)
                }
                async calculateAvailableForStake({
                    ...
                    const t = await this.getFee({
                        ...
                        n = new this.BN(this.reservedForStake),
                        a = e.toBN().sub(t).sub(n);
                    return new w.default(a.isNeg() ? "0" : a, this)
                }
                async createAutoClaimTransaction() {
                    const {
                        manager: e
                    } = await P(this, E, L).call(this), t = await e.methods.claimSetupManager().call(), n = await m.default.get(b.ConfigKey.FlareClaimExecutors), a = n.map(({
                        address: e
                    }) => e), i = n.reduce((e, {
                        fee: t
                    }) => e = e.add(new this.BN(this.toMinimalUnit(t))), new this.BN("0")).toString(), r = new this.coreLibrary.eth.Contract(d.default, t).methods.setClaimExecutors(a).encodeABI();
                    return this.createTransaction({
                        address: t,
                        paymentData: r,
                        amount: i,
                ...
                async getActiveAutoClaim() {
                    const {
                        manager: e
                    } = await P(this, E, L).call(this), t = await e.methods.claimSetupManager().call();
                    return new this.coreLibrary.eth.Contract(d.default, t).methods.claimExecutors(this.address).call()
                }
                async fetchDelegations(e = this.address) {
                    const t = new this.coreLibrary.eth.Contract(c.default, A).methods.delegatesOf(e),
                        {
                            _delegateAddresses: n,
                            _bips: a
                        } = await t.call();
                    return {
                        providers: n,
                        delegatePercentage: a
                    }
                }
                async fetchUnclaimedRewards(e = this.address) {
                    let t = new this.coreLibrary.eth.Contract(l.default, this.rewardsContract);
                    const n = await t.methods.newFtsoRewardManager().call();
                    n && Number(n) > 0 && (t = new this.coreLibrary.eth.Contract(l.default, n));
                    const a = await t.methods.getEpochsWithUnclaimedRewards(e).call();
                    return Promise.all(a.map(n => t.methods.getStateOfRewards(e, n).call()))
                }
                calculateDelegatedVotes(e) {
                    return Object.values(e).reduce((e, {
                        delegatedVotes: t
                    }) => e = e.add(t.toBN()), new this.BN("0"))
                }
                calculateAvailableVotes({
                    staked: e,
                    delegatedVotes: t
                }) {
                    return e.toBN().sub(t.toBN())
                }
                calculateRewards(e) {
                    return e.reduce((e, {
                        _rewardAmounts: t
                    }) => e = e.add(t.reduce((e, t) => e = e.add(new this.BN(t)), new this.BN("0"))), new this.BN("0"))
                }
                async fetchStakingInfo() {
                    var e, t;
                    const n = new w.default(null !== (e = null === (t = this.tokens[A.toLowerCase()]) || void 0 === t ? void 0 : t.balance) && void 0 !== e ? e : "0", this),
                        {
                            providers: a = [],
                            delegatePercentage: i = []
                        } = await this.fetchDelegations(),
                        r = await this.fetchUnclaimedRewards(),
                        s = a.reduce((e, t, a) => (e[t] = {
                            delegatedVotes: new w.default(n.toBN().div(new this.BN(100)).mul(new this.BN(i[a] / 100)).toString(), this)
                        }, e), {}),
                        o = await this.getActiveAutoClaim(),
                        u = new w.default(this.calculateDelegatedVotes(s), this),
                        c = this.calculateAvailableVotes({
                            staked: n,
                            delegatedVotes: u
                        }),
                        l = new w.default(this.calculateRewards(r), this),
                        d = (await m.default.get(b.ConfigKey.FlareClaimExecutors)).reduce((e, {
                            fee: t
                        }) => e = e.add(new this.BN(this.toMinimalUnit(t))), new this.BN("0"));
                    return {
                        staked: n,
                        validators: s,
                        availableVotes: new w.default(c.isNeg() ? "0" : c, this),
                        delegatedVotes: u,
                        availableWithdrawals: n,
                        rewards: l,
                        additional: {
                            autoClaimExecutors: o,
                            autoClaimFee: d,
                            activeAutoClaim: o && o.length > 0
                        }
                    }
                }
                getNextDropDate() {
                    const e = new Date;
                    return p.default.reduce((t, n) => {
                        const a = t - e;
                        return a > 0 && a < n - e ? t : n
                    })
                }
            }
            async function L() {
                let e = new this.coreLibrary.eth.Contract(l.default, this.rewardsContract);
                const t = await e.methods.newFtsoRewardManager().call(),
                    n = t && Number(t) > 0;
                return n && (e = new this.coreLibrary.eth.Contract(l.default, t)), {
                    manager: e,
                    address: n ? t : this.rewardsContract
                }
            }
            var x = FLRCoin;
            t.default = x
        ...
        5481: function(e, t, n) {
            ...
            t.keccak = function(e, t) {
                switch (void 0 === t && (t = 256), e = "string" != typeof e || c.isHexString(e) ? d.toBuffer(e) : Buffer.from(e, "utf8"), t || (t = 256), t) {
                    case 224:
                        return i(e);
                    case 256:
                        return s(e);
                ...
                return e = d.toBuffer(e), u("sha256").update(e).digest()
            }, t.ripemd160 = function(e, t) {
                e = d.toBuffer(e);
                var n = u("rmd160").update(e).digest();
                return !0 === t ? d.setLength(n, 32) : n
                ...
                async fetchStakingInfo() {
                    const e = Object.fromEntries(await Promise.all(this.predefinedValidators.map(async ({
                            ...
                            const t = await this.makeRawCall(o.default, this.stakingContract, "currentEpoch"),
                                ...
                                d = new r.default(c.toBN().add(l.toBN()).toString(), this);
                            return [e, {
        ...
        5554: function(e, t, n) {
            ...
            Object.defineProperty(p.prototype, "fingerprint", {
                ...
                if (this.privateKey) try {
                    y.privateKey = u.privateKeyTweakAdd(this.privateKey, d)
                } catch (t) {
                    return this.deriveChild(e + 1)
                } else try {
                    y.publicKey = u.publicKeyTweakAdd(this.publicKey, d, !0)
                } catch (t) {
                    return this.deriveChild(e + 1)
                }
        ...
        5560: function(e, t, n) {
            ...
            Object.defineProperty(f.prototype, "privKey", {
                ...
                var h = s.createCipheriv(t.cipher || "aes-128-ctr", n.slice(0, 16), l);
                if (!h) throw new Error("Unsupported cipher");
                var m = p(h, this.privKey),
                    b = r.keccak256(i.concat([n.slice(16, 32), i.from(m, "hex")]));
                return {
                    version: 3,
                    id: c({
                        random: t.uuid || o(16)
                ...
                return d("xpub" === e.slice(0, 4), "Not an extended public key"), e = l.decode(e).slice(45), f.fromPublicKey(e, !0)
            }, f.fromPrivateKey = function(e) {
                return new f(e)
            }, f.fromExtendedPrivateKey = function(e) {
                d("xprv" === e.slice(0, 4), "Not an extended private key");
                var t = l.decode(e);
                return d(0 === t[45], "Invalid extended private key"), f.fromPrivateKey(t.slice(46))
                ...
                var y = p(s.createDecipheriv("aes-128-cbc", r.keccak256(c.slice(0, 16)).slice(0, 16), i.from(n.Crypto.IV, "hex")), l);
                return new f(y)
                ...
                var h = p(s.createDecipheriv(l.crypto.cipher, o.slice(0, 16), i.from(l.crypto.cipherparams.iv, "hex")), y);
                return new f(h)
                ...
                var n = "object" === (void 0 === e ? "undefined" : a(e)) ? e : JSON.parse(e),
                    ...
                    c = p(s.createDecipheriv("aes-128-cbc", u, o.slice(0, 16)), o.slice(16)),
        ...
        5566: function(e, t, n) {
            ...
            t.ecsign = function(e, t, n) {
                ...
                var d = a.recover(e, c, l);
                return a.publicKeyConvert(d, !1).slice(1)
                ...
                var l = new i(t),
                    d = new i(n);
                return !(l.isZero() || l.gt(c) || d.isZero() || d.gt(c)) && (!a || 1 !== d.cmp(s))
        ...
        5568: function(e, t, n) {
            ...
            e.exports = function(e, t, n, r, s, o, u) {
                ...
                var c, l = new Buffer(256 * r),
                    d = new Buffer(128 * r * n),
                    p = new Int32Array(16),
                    f = new Int32Array(16),
                    y = new Buffer(64),
                    h = a(e, t, 1, 128 * s * r, "sha256");
                if (u) {
                    var m = s * n * 2,
                        b = 0;
                    c = function() {
                ...
                for (var g = 0; g < s; g++) v(h, 128 * g * r, r, n, d, l);
                return a(e, h, 1, o, "sha256");
        ...
        9028: function(e) {
            e.exports = JSON.parse("[1679011200000,1681603200000,1684195200000,1686787200000,1689379200000,1691971200000,1694563200000,1697155200000,1699747200000,1702339200000,1704931200000,1707523200000,1710115200000,1712707200000,1715299200000,1717891200000,1720483200000,1723075200000,1725667200000,1728259200000,1730851200000,1733443200000,1736035200000,1738627200000,1741219200000,1743811200000,1746403200000,1748995200000,1751587200000,1754179200000,1756771200000,1759363200000,1761955200000,1764547200000,1767139200000,1769731200000]")
        },
        9029: function(e) {
            e.exports = JSON.parse('[{"name":"Wrapped Flare","ticker":"WFLR","contract":"0x1D80c49BbBCd1C0911346656B529DF9E5c2F783d","decimal":"18","visibility":true}]')
        }
    }
]);